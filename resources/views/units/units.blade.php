...
<div class="pcoded-content">
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                    ...
                    <div class="modal-content">
                        ...
                        <form id="tambahunits" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                ...
                <div class="modal-content">
                    ...
                    <form id="editunits" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
...
$(document).ready(function() {
     ...
     $('#editunits').submit(function(e) {
  e.preventDefault();
  let formData = new FormData(this);
  $.ajax({
     type:'POST',
     url: `{{ route('units.updated') }}`,
      data: formData,
      contentType: false,
      processData: false,
